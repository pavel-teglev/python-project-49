...
def-env activate-virtualenv [] {
    ...
    let virtual_env = '/Users/pavelteglev/Desktop/Python/Python_Back_end/Hexlet-project/python-project-49/.venv'
    let bin = 'bin'
    let path_sep = ':'
    ...
    let virtual_prompt = if ('python-project-49-py3.9' == '') {
        $'(char lparen)($virtual_env | path basename)(char rparen) '
    } else {
        '(python-project-49-py3.9) '
    }
...
alias deactivate = source '/Users/pavelteglev/Desktop/Python/Python_Back_end/Hexlet-project/python-project-49/.venv/bin/deactivate.nu'
